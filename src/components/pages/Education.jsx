          ...
          <section className="education">
               <div>
                    ...
                    <Row>
                         <Col xs={12}>
                              <ul>
                                   <li><b>Full Stack Coding Bootcamp at UC Berkeley </b>(pursuing)</li>
                                   <li><b>Master of Science,</b> Information Technology, University of the Cumberlands, U.S. (pursuing)</li>
